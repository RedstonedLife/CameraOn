...
public class HardwareUtils {
    ...
    public void LogInfo() {
        ...
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.line1"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.line2"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.line3"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.cpu"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.cpu.vendor", cpu.getVendor()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.cpu.name", cpu.getName()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.cpu.id", cpu.getId()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.cpu.identifier", cpu.getIdentifier()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.cpu.microarchitecture", cpu.getMca()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.cpu.operatingfrequency", cpu.getVendorGFreqSTR()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.baseboard"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.baseboard.manufacturer", baseboardInfo.getManufacturer()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.baseboard.model", baseboardInfo.getModel()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.baseboard.serial", baseboardInfo.getSerial()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.baseboard.version", baseboardInfo.getVersion()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.line1"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.line2"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.line3"));
        for(StorageDevice sdev : storageDevices) {
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.device", sdev.getMount()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.description", sdev.getDescription()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.label", sdev.getLabel()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.logicalvolume", sdev.getLogicalVolume()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.mount", sdev.getMount()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.name", sdev.getName()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.options", sdev.getOptions()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.type", sdev.getType()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.uuid", sdev.getUUID()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.volume", sdev.getVolume()));
            Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.storage.space", FormatUtil.formatBytes(sdev.getFreeSpace()), FormatUtil.formatBytes(sdev.getTotalSpace()), FormatUtil.formatBytes(sdev.getUsableSpace())));
        }
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.line1"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.line2"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.line3"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.os"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.osname", os.getOSF()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.osfamily", os.getFamily()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.osmanufacturer", os.getManufacturer()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.osbitarchitecture", os.getBits()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.osversion",os.getVersion()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.oscodename",os.getCodename()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.osbuildnumber", os.getBuild_Number()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.bios"));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.biosdescription", firmwareInfo.getDescription()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.biosmanufacturer", firmwareInfo.getManufacturer()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.biosname", firmwareInfo.getName()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.biosreleasedate", firmwareInfo.getReleaseDate()));
        Logger.getLogger("BNC").stamplessInfo(tl("hardwareinfo.firmware.biosversion", firmwareInfo.getVersion()));
        Logger.getLogger("BNC").stamplessInfo("##################################");
    }
}
