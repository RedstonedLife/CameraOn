...
public class HardwareUtils {
    ...
    public void LogInfo() {
        ...
        Logger.getLogger("BNC").info(tl("hardwareinfo.firmware.osversion",os.getVersion()));
        ...
        Logger.getLogger("BNC").info(tl("hardwareinfo.firmware.bios"));
        Logger.getLogger("BNC").info(tl("hardwareinfo.firmware.biosmanufacturer", firmwareInfo.getManufacturer()));
        Logger.getLogger("BNC").info(tl("hardwareinfo.firmware.biosdescription", firmwareInfo.getManufacturer()));
        Logger.getLogger("BNC").info(tl("hardwareinfo.firmware.biosmanufacturer", firmwareInfo.getManufacturer()));
        Logger.getLogger("BNC").info(tl("hardwareinfo.firmware.biosmanufacturer", firmwareInfo.getManufacturer()));
