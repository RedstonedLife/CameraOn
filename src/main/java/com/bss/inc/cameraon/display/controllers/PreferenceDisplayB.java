...
public class PreferenceDisplayB implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        $UI$01.u_08$1$2(new TextField[]{threadsDelayTf,threadsMaxTf,pingProbesTf,pingTimeoutTf,defaultPortTimeoutTf,minAdptdConTimeoutTf},new CheckBox[]{scanDeadHostsCHKb,});
