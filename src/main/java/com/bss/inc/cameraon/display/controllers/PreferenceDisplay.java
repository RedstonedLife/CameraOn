...
public class PreferenceDisplay implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        asSceneBtn.setOnAction(e -> {MainClass.getWindowManager().changeDialogScene("preferencesDialog",MainClass.getResource(FrontendPaths.PREF_DISPLAY_AS_FXML));});
        ibsSceneBtn.setOnAction(e -> {MainClass.getWindowManager().changeDialogScene("preferencesDialog",MainClass.getClass().getResource(FrontendPaths.PREF_DISPLAY_IBS_FXML));});
        cbsSceneBtn.setOnAction(e -> {MainClass.getWindowManager().changeDialogScene("preferencesDialog",MainClass.getClass().getResource(FrontendPaths.PREF_DISPLAY_CBS_FXML));});
        displaySceneBtn.setOnAction(e -> {MainClass.getWindowManager().changeDialogScene("preferencesDialog",MainClass.getClass().getResource(FrontendPaths.PREF_DISPLAY_FXML));});
        initializeLanguage();
    }
}
